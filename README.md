...
In this link [[Baidu Disk](https://pan.baidu.com/s/11Ci0L7VbOSlpanLdGUDcDA?pwd=8g4q)], we provide two versions of the pre-trained weights for LoIS:

1. `FAPL.pth` (550MB): Trained from CLIP ViT-Large (PyTorch).
